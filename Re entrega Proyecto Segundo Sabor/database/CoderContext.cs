...
namespace Re_entrega_Proyecto_Segundo_Sabor.database
{
    public partial class CoderContext : DbContext
    {
        ...
        public virtual DbSet<FormProductoVendido> ProductoVendido { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-USALU3H\\SQLEXPRESS; Database=coderhouse; Trusted_Connection = True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FormProductoVendido>(entity =>
            {
